...
export const AI_MODELS: readonly AiModelDef[] = [
  ...
  // ── External API models (user-connected via Google Gemini API Direct) ──
  {
    value: 'vertex-flash',
    label: 'Gemini 2.5 Flash (Direct API)',
  ...
  {
    value: 'vertex-pro',
    label: 'Gemini 2.5 Pro (Direct API)',
    desc: 'Your API · Best for long-form · ~45s',
    speed: 45,
    source: 'external-api',
    provider: 'Google Gemini API',
    capabilities: ['text', 'text-premium'],
  ...
  },
  {
    ...
    label: 'Gemini 3.1 Pro Preview (Direct API)',
  ...
  },
  {
    ...
    label: 'Gemini 3 Flash (Direct API)',
  ...
  },
  {
    ...
    label: 'Gemini 3.1 Flash-Lite (Direct API)',
  ...
  },
  {
    ...
    label: 'Gemini 3 Pro Image (Direct API)',
  ...
  },
  {
    ...
    label: 'Gemini 2.5 Flash Image (Direct API)',
    desc: 'Your API · Fast image generation',
    speed: 20,
    source: 'external-api',
    provider: 'Google Gemini API',
    capabilities: ['image'],
  ...
  },
  {
    ...
    label: 'Gemini 3.1 Flash Image (Direct API)',
