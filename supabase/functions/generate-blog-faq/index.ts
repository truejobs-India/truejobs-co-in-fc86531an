...
async function callAI(model: string, prompt: string): Promise<string> {
  ...
  switch (model) {
    ...
    default:
      throw new Error(`Unsupported AI model: "${model}". Supported: gemini, mistral, claude-sonnet, openai, groq, lovable-gemini, vertex-flash, vertex-pro, vertex-3.1-pro, vertex-3-flash, vertex-3.1-flash-lite, nova-pro, nova-premier, nemotron-120b, azure-gpt4o-mini, azure-gpt41-mini, azure-deepseek-v3`);
  }
}
